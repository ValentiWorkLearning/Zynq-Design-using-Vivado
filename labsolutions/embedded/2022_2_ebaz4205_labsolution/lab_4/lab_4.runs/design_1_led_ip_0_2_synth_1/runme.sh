...
HD_PWD='D:/Zynq-Design-using-Vivado/labsolutions/embedded/2022_2_ebaz4205_labsolution/lab_3/lab_3.runs/design_1_led_ip_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_led_ip_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_led_ip_0_2.tcl
