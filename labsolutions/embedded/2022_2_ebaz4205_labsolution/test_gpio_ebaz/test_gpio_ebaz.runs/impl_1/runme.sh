...
HD_PWD='D:/Zynq-Design-using-Vivado/labsolutions/embedded/2022_2_ebaz4205_labsolution/test_gpio_ebaz/test_gpio_ebaz.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ebaz_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ebaz_design_wrapper.tcl -notrace
