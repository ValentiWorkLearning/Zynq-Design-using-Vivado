...
HD_PWD='D:/Zynq-Design-using-Vivado/labsolutions/embedded/2022_2_ebaz4205_labsolution/test_gpio_ebaz/test_gpio_ebaz.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ebaz_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ebaz_design_wrapper.tcl
